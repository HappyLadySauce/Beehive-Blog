...
func (l *ListContentsLogic) ListContents(req *types.ContentListRequest) (resp *types.ContentListResponse, err error) {
	out, err := l.svcCtx.Content.ListContents(l.ctx, &contentrpc.ListContentsRequest{
		Page:     req.Page,
