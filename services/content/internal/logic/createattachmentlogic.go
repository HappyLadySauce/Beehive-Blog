...
func NewCreateAttachmentLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateAttachmentLogic {
	return &CreateAttachmentLogic{ctx: ctx, svcCtx: svcCtx, Logger: logx.WithContext(ctx)}
}

func (l *CreateAttachmentLogic) CreateAttachment(in *pb.CreateAttachmentRequest) (*pb.Attachment, error) {
	out, err := l.svcCtx.Store.CreateAttachment(l.ctx, in)
	if err != nil {
