...
func NewCreateRelationLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateRelationLogic {
	return &CreateRelationLogic{ctx: ctx, svcCtx: svcCtx, Logger: logx.WithContext(ctx)}
}

func (l *CreateRelationLogic) CreateRelation(in *pb.CreateRelationRequest) (*pb.Relation, error) {
	out, err := l.svcCtx.Store.CreateRelation(l.ctx, in)
	if err != nil {
