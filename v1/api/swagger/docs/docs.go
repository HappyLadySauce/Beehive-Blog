...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/v1.AdminPageListResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.CreatePageRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/v1.PageDetailResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.UpdatePageRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/v1.DeletePageResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.UpdatePageStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/settings/smtp/test": {
            "post": {
                ...
                "responses": {
                    ...
                    "502": {
                        "description": "上游 SMTP 失败；message 为脱敏后的错误原因（非统一 internal server error）",
                        "schema": {
                            "$ref": "#/definitions/common.BaseResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "v1.AdminPageListResponse": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.AdminPageListItem"
                    }
                },
                "page": {
                    "type": "integer"
