import { BookOpen, Database, FileArchive, FileText, MessageSquare, Settings, Sparkles, Tags, Users } from "lucide-react";
...
export const studioNavItems = [
  ...
  { href: "/studio/comments", label: "评论", icon: MessageSquare },
