    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-medium text-gray-900">附件管理</h2>
        </div>
        <div>
          <input 
            type="file" 
      ...
      {loading ? (
        ...
        <div className="py-12 text-center text-gray-500 bg-white border border-gray-200 rounded">暂无附件</div>
      ) : (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {attachments.map((attachment) => (
            <div key={attachment.id} className="bg-white border border-gray-200 rounded overflow-hidden group relative">
              ...
              <div className="p-2 border-t border-gray-100">
                <div className="text-xs font-medium text-gray-900 truncate" title={attachment.originalName}>
              ...
              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                <button 
                  ...
                  className="p-2 bg-white text-gray-700 rounded-full hover:text-blue-600 transition-colors"
                  title="复制链接"
                >
                ...
                <button 
                  ...
                  className="p-2 bg-white text-gray-700 rounded-full hover:text-red-600 transition-colors"
                  title="删除"
                >
